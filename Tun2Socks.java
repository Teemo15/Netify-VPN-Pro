package com.netify.ultrasshservice.tunnel.vpn;
...
import com.netify.ultrasshservice.util.StreamGobbler;
//import android.support.v4.content.ContextCompat;
import com.netify.ultrasshservice.logger.SkStatus;
import com.netify.ultrasshservice.util.CustomNativeLoader;
 		...
 		try {
			...
			if (mVpnInterfaceFileDescriptor != null){
				...
				if (mDnsResolverAddress != null) {
                    ...
                    SkStatus.logInfo("Dnsgw Relay: " + mDnsResolverAddress);
				}
